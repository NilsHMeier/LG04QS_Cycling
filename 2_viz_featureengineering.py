...
data_table = PrepareDataset.fill_datatable(source_path=SOURCE_PATH, labelcol_name='label', names=['LP', 'NB', 'NM'])
...
# Scattering all datapoints in the prepared datatable using the defined colors
for i in data_table.index:
    ...
    if label not in labels:
        labels[label] = pt
# Set the axis label to the choosen feature
